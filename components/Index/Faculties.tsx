...
const Faculties = () => {
  return (
    <div className='mt-[98px] lg:mx-[28px] md:mx-[28px] mx-[14px]' >
        ...
        <div className='bg-[var(--subwhite)] rounded-[18px] lg:py-[24px] md:py-[24px] lg:px-[30px] md:px-[30px] py-[14px] px-[14px] mt-[24px]' >
            <div className='flex lg:justify-end md:justify-end justify-between  items-center lg:gap-[12px] md:gap-[12px] gap-[6px]' >
                <input 
                    className='bg-white rounded-[28px] py-[13px] px-[24px] lg:w-[460px] md:w-[460px] w-[190px]'
                    placeholder='Enter your pincode '
                    type="text" /> 
                <button className='lg:px-[52px] md:px-[52px]  lg:py-[12px] md:py-[12px] px-[36px] py-[8px] rounded-[28px] lg:text-[18px] md:text-[18px] text-[14px] font-[500] bg-[var(--orange)] !text-[var(--background)]' >View all</button>
            </div>
            ...
            <p className='lg:text-[16px] md:text-[16px] text-[10px] text-center font-[400] mt-[32px]' >Find top sports facilities near you with ease! Whether it&apos;s a turf, court, or arena, locate the perfect venue for your  next game in just a few taps. Play at the best spots, anytime, anywhere.</p>
