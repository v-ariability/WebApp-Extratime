...
const Inspiration = () => {
  return (
    <div className='mt-[98px] mx-[14px] md:mx-[28px] lg:mx-[28px]' >  
        ...
        <div className='lg:mt-[48px] md:mt-[48px] mt-[24px] lg:px-[98px] md:px-[61px] px-[14px] lg:py-[72px] md:py-[72px] py-[24px] bg-[var(--subwhite)] rounded-[28px]' >
            ...
            <div className='lg:flex md:flex grid grid-cols-3 gap-[8px] items-center justify-center mt-[24px]'  >
                <button className='lg:text-[18px] md:text-[18px] text-[14px] font-[400] px-[27px] py-[12px] rounded-[28px] bg-white' >Football</button>
                <button className='lg:text-[18px] md:text-[18px] text-[14px] font-[400] px-[27px] py-[12px] rounded-[28px] bg-[var(--orange)] !text-white' >Cricket</button>
                <button className='lg:text-[18px] md:text-[18px] text-[14px] font-[400] px-[27px] py-[12px] rounded-[28px] bg-white' >Basketball</button>
                <button className='lg:text-[18px] md:text-[18px] text-[14px] font-[400] px-[27px] py-[12px] rounded-[28px] bg-white' >Tennis</button>
                <button className='lg:text-[18px] md:text-[18px] text-[14px] font-[400] px-[27px] py-[12px] rounded-[28px] bg-white' >Table Tennis</button>
                <button className='lg:text-[18px] md:text-[18px] text-[14px] font-[400] px-[27px] py-[12px] rounded-[28px] bg-white' >Boxing</button>
            </div>
