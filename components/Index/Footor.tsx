...
const Footor = () => {
  return (
    <div className='mt-[98px] h-[506px] bg-black px-[28px] pt-[44px] pb-[24px] flex items-start justify-between relative overflow-hidden' >
        ...
        <div>
          ...
          <div className='flex rounded-[28px] pr-[2px] py-[2px] bg-white w-[316px] items-center justify-between' >
          ...
          <ul className='mt-[24px] block gap-[16px]' >
        ...
        <p className='!text-white lg:text-[252px] md:text-[190px] font-[400] absolute bottom-[-120px] left-[0px] z-20 ' >EXTRATIME</p>
    </div>
  )
}
